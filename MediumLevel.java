...
public class MediumLevel extends MainActivity {
    ...
    Database sqlcon = new Database(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (boolTotal > 15) {
                    gameOverDialog.show();
                    if (db.getMediumHighScores().getCount() >= 0) {
                        db.addMediumHighScore(new HighScores(count, name));
                    } else {
                        db.onCreateMedium(sqlConn);
                    }
        ...
        gameOverDialog.setPositiveButton("Restart", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                ...
                .setNegativeButton("High Scores", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Cursor res = db.getMediumHighScores();
                        StringBuffer buffermed = new StringBuffer();

                        while (res.moveToNext()) {
                            buffermed.append("Score:" + res.getString(0) + "\t");
                            buffermed.append("Initials: " + res.getString(1) + "\n");
                        }
                        showMessage("High Scores", buffermed.toString());
                    }
                });
